...
void Open4XVulkan::createInstance() {
...
QueueFamilyIndices Open4XVulkan::findQueueFamilies(VkPhysicalDevice device) {
...
bool Open4XVulkan::isDeviceSuitable(VkPhysicalDevice device) {
...
void Open4XVulkan::createLogicalDevice() {
...
void Open4XVulkan::setupDebugMessenger() {
  if (!enableValidationLayers)
    return;
...
void Open4XVulkan::createSwapChain() {
...
void Open4XVulkan::createRenderPass() {
...
void Open4XVulkan::createVertexBuffer() {
